...
void CGapODE::ODEIntegrate(void)
{
	...
	myNewtonIteration.xp.resize(4); myNewtonIteration.xp = 0.0;
	do
	{
...
<<<<<<< HEAD
			...
			<< "\t" << myNewtonIteration.gapcorrection[0]									//52
			<< "\t" << myNewtonIteration.gapcorrection[1]									//53
			<< "\t" << myNewtonIteration.gapcorrection[2]									//54
			<< "\t" << myNewtonIteration.gapcorrection[3]									//55
=======
			<< "\t" << myNewtonIteration.xp(0)												//52
			//<< "\t" << myNewtonIteration.myPistonGap.forcespistongap.F_contact[1]			//53
			<< "\t" << myNewtonIteration.xp(1)												//53
			//<< "\t" << myNewtonIteration.myPistonGap.forcespistongap.F_contact[2]			//54
			<< "\t" << myNewtonIteration.xp(2)												//54
			//<< "\t" << myNewtonIteration.myPistonGap.forcespistongap.F_contact[3]			//55
			<< "\t" << myNewtonIteration.xp(3)												//55
>>>>>>> fpworks/ContactAlgorithmTest
