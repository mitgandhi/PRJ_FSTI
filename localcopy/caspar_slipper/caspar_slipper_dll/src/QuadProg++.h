//The QuadProg++ library originally had two files QuadProg++.h and Array.h
//I have smushed them together into this one file. Array.h comes first, then QuadProg++.h
// - Andrew 1/29/2013

//Array.h - Andrew 1/29/2013
